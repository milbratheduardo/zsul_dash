...
import ModalEditarAtleta_lp from './ModalEditarAtleta_lp';

const ModalAtletasOpcoes_lp = ({ isVisible, onClose, atletaNome, currentColor, atleta,}) => {
...
export default ModalAtletasOpcoes_lp;