...
const ModalEditarAtleta_lp = ({ isVisible, onClose, currentColor, teamId, atletaId, atletaNome }) => {
          ...
          <form className='mt-4 space-y-4' onSubmit={handleSubmit}>
            ...
            <div className='-space-y-px'>
              {fields.map((field, index) => {
                if (field.id === 'name' || field.id === 'documentNumber') {
                  return null;
                }
                return (
...
export default ModalEditarAtleta_lp;
