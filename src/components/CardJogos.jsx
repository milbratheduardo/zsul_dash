...
const CardCompetition = ({ 
  ...
  useEffect(() => {
    const fetchGroups = async () => {
      try {
        const response = await fetch(`https://zsul-api.onrender.com/grupos/${grupoId}`);
  ...
  useEffect(() => {
    const fetchUserCasaInfo = async () => {
      ...
      try {
        const response = await fetch(` https://zsul-api.onrender.com/users/${userCasa}`);
  ...
  useEffect(() => {
    const fetchUserForaInfo = async () => {
      ...
      try {
        const response = await fetch(` https://zsul-api.onrender.com/users/${userFora}`);
  ...
  useEffect(() => {
    const fetchEstatisticasJogo = async () => {
        try {
            const response = await fetch(` https://zsul-api.onrender.com/estatistica/jogo/${jogoId}`);
            const data = await response.json();
