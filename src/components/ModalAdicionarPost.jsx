...
import { ModalAdicionarPostFields } from '../constants/formFields';
...
const fields = ModalAdicionarPostFields;
let fieldsState = {};
fields.forEach((field) => (fieldsState[field.id] = ''));

const ModalAdicionarPost = ({ isVisible, onClose, currentColor }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const postData = {
            ...
            subtitulo: modalFieldsState.subtitulo,
            texto: modalFieldsState.texto,
            imagem: '',
        ...
        <div className='fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center' id='wrapper' onClick={handleClose}>
            <div className='w-full sm:w-[400px] md:w-[500px] lg:w-[600px] flex flex-col' style={{ height: '100%', maxHeight: '600px' }}>
                ...
                <div className='bg-white p-2 rounded' style={{ maxHeight: '100%', overflowY: 'auto' }}>
                    <HeaderModal title='Cadastre novo Post' heading='Preencha todos os dados' />
...
export default ModalAdicionarPost;
